...
def main(num_mesh_refines: int, show_plots: bool):
	...
	if not os.path.exists("data"):
		os.makedirs("data")
	if not os.path.exists("plot_poisson"):
		os.makedirs("plot_poisson")
	...
	with dolfinx.io.XDMFFile(msh_f.comm, "data/fine-LOD_diff.xdmf", "w", encoding=XDMFFile.Encoding.ASCII) as xdmf:
		xdmf.write_mesh(msh_f)
	...
	plotter.view_xy()
	plotter.screenshot("plot_poisson/fine-LOD_diff.png")
	plotter.close()
